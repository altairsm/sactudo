#!/bin/bash
mysqlRootPassword="Asm501578" ##a senha de root do mysql para sua senha definitiva de root
adduser deploy
...
sudo -H -u deploy bash -c "sudo -H -u deploy bash -c "git clone https://github.com/canove/whaticket whaticket"
